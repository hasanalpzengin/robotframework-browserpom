...
# BrowserPOM Discovery CLI (Create PageObjects)
...
Note on skill references: other skills commonly refer to the skill name that should be invoked. For example, to reference the test-creation skill use `/browserpom-create-robot-tests`.
