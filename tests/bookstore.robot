...
Test Setup    Browser.Open Browser    https://automationbookstore.dev     headless=False
...
Search
    ...
    Should Be Equal As Strings    ${MainPage.content_area.tile[1].title}    .ui-content >> //li>> nth=1 >> //h2[contains(@id, '_title')]
